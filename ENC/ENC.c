...
{
	macddr[5] = enc28j60Read(MAADR0);
	macddr[4] = enc28j60Read(MAADR1);
	macddr[3] = enc28j60Read(MAADR2);
	macddr[2] = enc28j60Read(MAADR3);
	macddr[1] = enc28j60Read(MAADR4);
	macddr[0] = enc28j60Read(MAADR5);
}
/****************************************************************************************************
 *																									*
 ****************************************************************************************************/
void enc28j60Init(uint8_t* macaddr)
{
	...
	enc28j60Write(ERXFCON, ERXFCON_UCEN|ERXFCON_CRCEN|ERXFCON_PMEN|ERXFCON_BCEN);	//ERXFCON_BCEN
	...
	enc28j60Write(MAMXFLL, 1518&0xFF);
	enc28j60Write(MAMXFLH, 1518>>8);
	// do bank 3 stuff
        // write MAC address
